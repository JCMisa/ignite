...
const StartupDetails = async ({
  ...
  // with parallel fetching the loading time of all the methods passed in the array are the same not summed up, hence faster loading time
  ...
  // this is sequential fetching where the loading is slower
